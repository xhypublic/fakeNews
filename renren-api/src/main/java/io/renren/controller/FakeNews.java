...
public class FakeNews {
    ...
    public R fakeNews(/*@RequestBody String t, @RequestBody String c*/HttpServletRequest httpRequest, HttpServletResponse httpResponse) throws JsonProcessingException {
        ...
        FileUtils.save2File("E:\\code\\data\\ERD_data\\mydata\\test\\unknow_label\\"+id+"\\source-tweet\\"+id+".json", json);

        String[] arguments = new String[] {"python", "E:\\code\\ERD-master\\main.py","batch_size","1"};
        try {
    ...
    public R fakeNewsFiles(@RequestParam("file") MultipartFile file) throws IOException {
        ...
        String[] arguments = new String[] {"python", "E:\\code\\ERD-master\\main.py","batch_size","10"};
        try {
            Process process = Runtime.getRuntime().exec(arguments);
            BufferedReader in = new BufferedReader(new InputStreamReader(process.getInputStream(),"GBK"));
            String line = null;
